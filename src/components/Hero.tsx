...
const Hero = () => {
 ...
 <div className="bg-black rounded-lg lg:m-4 lg:p-8 bg-opacity-65 lg:flex-grow md:w-1/2 lg:pl-12 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
